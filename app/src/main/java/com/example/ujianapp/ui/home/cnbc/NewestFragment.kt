...
import com.example.ujianapp.databinding.FragmentCnbcNewestBinding
...
class NewestFragment : Fragment() {
    ...
    private lateinit var binding: FragmentCnbcNewestBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCnbcNewestBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newestViewModel.cnbcNewestNews.observe(viewLifecycleOwner) {
            nAdapter.setData(it.data!!)
            binding.rvCnbcNewestNews.apply {
                adapter = nAdapter
